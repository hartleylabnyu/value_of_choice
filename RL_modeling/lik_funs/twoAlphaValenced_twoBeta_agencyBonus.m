...
function [lik, latents] = twoAlphaValenced_twoBeta_agencyBonus(QbanditOrder, agencyChoiceVec, banditChoiceVec, outcome, agency, offer, leftBandit, rightBandit, x, priors)
