...
function [lik, latents] = twoAlphaValenced_oneBeta_agencyBonus(banditChoice, outcome, agency, offer, leftBandit, rightBandit, x, priors)
...
if (priors)
    lik = lik + log(betapdf(alpha_pos, 1.1, 1.1));
    lik = lik + log(betapdf(alpha_neg, 1.1, 1.1));
