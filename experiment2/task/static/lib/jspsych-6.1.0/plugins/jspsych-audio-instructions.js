    ...
    plugin.info = {
        ...
        parameters: {
            ...
            audio_stim: {
                ...
                pretty_name: 'audio',
                default: 'static/audio/instructions1.wav',
                array: true,
    ...
    plugin.trial = function (display_element, trial) {
        ...
        function show_current_page() {
            ...
            if(context !== null){
                ...
                source.buffer = jsPsych.pluginAPI.getAudioBuffer(trial.audio_stim[current_page]);
                source.connect(context.destination);
            } else {
            var audio = jsPsych.pluginAPI.getAudioBuffer(trial.audio_stim[current_page]);
            audio.currentTime = 0;
            }

            console.log(trial.audio_stim[current_page])
